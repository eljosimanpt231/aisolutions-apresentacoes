# Design: ERTEC v2 (ertec-m4t8)

> Variante da ertec-p9r4 com as secoes de proveniencia: anatomia do motor,
> terminal de logs e backoffice (catalogo e pipeline de propostas).
